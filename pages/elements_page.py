...
class ElementsPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.center_text = WebElement(driver, '.pattern-backgound.playgound-header')
        self.body_text = WebElement(driver, '.col-12.mt-4.col-md-6')
        ...
        self.side_bar = WebElement(driver, 'div.row > div:nth-child(1)')
